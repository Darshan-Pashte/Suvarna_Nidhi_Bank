import classes from "./CheckerView.module.css";
...
const CheckerView = ({ accList }) => {
  ...
  const handleNavigate = (data) => {
    navigate("/checkerviewrecord", { state: data });
  };
        ...
        <div style={{ width: '100%', marginBottom: '1vh' }}>
          ...
          >
            ...
            <Grid item xs={12} sm={4} md={3}>
              ...
              <ColorButton2 variant="contained" type="submit" onClick={() => handleNavigate()}>
                View Batch Status
              </ColorButton2>
            </Grid>
          </Grid>
