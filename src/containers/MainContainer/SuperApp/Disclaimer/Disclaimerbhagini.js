...
export default function Disclaimerbhagini() {
        ...
        <div>
            <div className={classes.mainpageTermsConditions}>
                ...
                <div className={classes.imagesbhagini}>
                    ...
                    <b>Legal Notice and Disclaimer for Bhagini Nivedita Sahakari Bank Ltd.</b>
                    <br />
                    <br />
                    <b>Legal Notice</b>
                    <br />
                    Please carefully review the terms and conditions set forth below before using this website. By accessing, browsing, or utilizing this site and any of its pages, you acknowledge your agreement to be bound by these terms and conditions. Material available on this website may be downloaded for non-commercial, personal use only, under the condition that all copyright and proprietary notices are preserved intact. Distribution, alteration, transmission, re-utilization, reporting, or employing the site's content for public or commercial activities, including but not limited to text, images, audio, and video, is strictly prohibited without the express written consent of Bhagini Nivedita Sahakari Bank Ltd.
                    <br />
                    Copyright (c) Bhagini Nivedita Sahakari Bank Ltd., All Rights Reserved. The content displayed on this site, along with information submitted to the bank via this site, shall remain the exclusive property of Bhagini Nivedita Sahakari Bank Ltd., unless specified otherwise.
                    <br />
                    <br />
                    <b>Trademarks</b>
                    <br />
                    The name Bhagini Nivedita Sahakari Bank Ltd. and its logo are duly registered trademarks and service marks belonging to the bank.
                    <br />
                    <br />
                    <b>Use of Information and Materials</b>
                    <br />
                    The content and materials on this website are presented solely for informational purposes and should not be interpreted as an offer, solicitation, invitation, advice, or recommendation to purchase or dispose of any financial instruments or banking products offered by Bhagini Nivedita Sahakari Bank Ltd.
                    <br />
                    Content and materials, along with terms, conditions, and descriptions on this website, are amendable. Not every product or service mentioned is accessible in every geographic location. Eligibility for particular products and services is contingent upon final determination and approval by Bhagini Nivedita Sahakari Bank Ltd., and is based on the specific terms and conditions under which they are provided.
                    <br />
                    <br />
                    <b>Disclaimer</b>
                    <br />
                    ...
                    <br />
                    Content and materials on this site are offered "as is" and "as available," with efforts made to maintain accuracy and correctness. However, Bhagini Nivedita Sahakari Bank Ltd. does not guarantee the continuity or currency of information at the time it is accessed by users.
                    <br />
                    Bhagini Nivedita Sahakari Bank Ltd. disclaims all liability for any direct or indirect loss or damage (including, but not limited to, special, incidental, or consequential loss or damage) arising from the use of this website, including any losses, damages, or expenses stemming from, but not limited to, defects, errors, imperfections, faults, mistakes, or inaccuracies in this website, its contents, or associated services, or due to the unavailability of the website or any part thereof or any contents or associated services.
                    <br />
                    Bhagini Nivedita Sahakari Bank Ltd. does not assure the receipt of emails sent from the website nor guarantees the privacy and/or security of emails during internet transmission.
                    <br />
                    <br />
