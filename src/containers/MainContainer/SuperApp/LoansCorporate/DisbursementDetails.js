...
const CorporateDisbursementDetails = () => {
    ...
    <>
      ...
      <div className={classes.redrow}>
        ...
        >
          <div className={classes.firsttabinfo}>
            ...
            >
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <div className={classes.boldtext}>
                  {state?.loanAcctDetails?.acctHolderName}
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <div className={classes.boldtext}>
                  {state?.loanAcctDetails?.disbursedAmt}
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <div className={classes.boldtext}>
                  {state?.loanAcctDetails?.sanctionDate}
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <div className={classes.boldtext}>
                  {state?.loanAcctDetails?.totalSanctionAmt}
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <div className={classes.boldtext}>
                  {state?.loanAcctDetails?.disbursalStatus}
                </div>
              </Grid>
          ...
          <div className={classes.Sbox2} style={{ marginTop: "3vw" }}>
            <div style={{ width: "100%", marginBottom: "10px" }}>
              <MUIDataTable
                title={"Disbursement Detail"}
                data={state?.loanDisbursementDetails}
                columns={columns}
                options={options}
              />
            </div>
...
export default CorporateDisbursementDetails;
