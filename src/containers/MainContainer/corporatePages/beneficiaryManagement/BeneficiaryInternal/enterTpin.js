...
export default function EnterOTP({
  ...
  const onSubmits = async (data) => {
    ...
    const response = await postApiData(apiList.CORPORATE_BENEFICIARYDELETE, payload);
...
<div className={classes.updatepass}>Enter TPIN  <sup className={classes.required}>*</sup></div>
