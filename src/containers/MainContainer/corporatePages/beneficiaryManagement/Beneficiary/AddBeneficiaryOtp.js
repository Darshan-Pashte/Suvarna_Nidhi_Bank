...
export default function AddBeneficiaryOtp({ open, handleOpen, handleClose, userId, payloads, custNo, payloadData, payLoad, fileData, airtelFileUpload, setAirtelFile ,response}) {
    ...
    const onSubmits = async (data) => {
        ...
        const response = await postApiData(apiList.CORPORATE_BENEFICIARYADD, payload);
