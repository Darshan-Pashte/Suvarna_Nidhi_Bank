...
export default function FixedDepositCashCertCorporate() {
              ...
              <Table  aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell >Date of Recpt</StyledTableCell>
                ...
                <TableBody>
                  {receiptList &&  receiptList?.map((row) => (
                    ...
                    <StyledTableCell align="right">{changeDate(row.asOfDate)}
