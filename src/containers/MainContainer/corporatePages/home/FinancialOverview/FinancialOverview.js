...
const FinancialOverview = ({accList}) => {
      ...
      <Grid item xs={12} sm={12} md={12}>
        ...
        <Box className={classes.tableMainBox}>
          ...
          >
            ...
            >
              <Tab style={{ color: 'var(--common-heading-color)' }} label="Bank Account" {...a11yProps(0)} />
          ...
          <div className={classes.tabContent}>
            <CustomTabPanel value={valueTable} index={0}>
              <BankAccounttable accList={accList}/>
            </CustomTabPanel>
            <CustomTabPanel value={valueTable} index={1}>
              <LoanTable accList={accList} />
            </CustomTabPanel>
          </div>
