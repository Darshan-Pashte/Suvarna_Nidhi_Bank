...
//   custNo: "",
// };
const LoanTable = ({ accList }) => {

  const { useFormData, defaultFormData, setLoanAccounts, loanAccounts, setCustNoContext, custNoContext } = useContext(ConnContext);
  const {
    control,
    handleSubmit,
    setValue,
      ...
      options: {
        ...
        customBodyRender: (value, { rowData, rowIndex }, tableMeta) => {
          ...
          return (
            <img src={Eye}
              alt="Eye Icon"
              onClick={() => navigate("/account/loandetails", { state: loanAccounts[rowIndex] })}
  ...
  return (
    <>
      ...
      <Box className={classes.tableMainBox} component="form"
      >
        {/* <Box
        ...
        >
          <Grid item xs={12} sm={6} md={8} style={{ paddingBottom: "2vw" }}></Grid>

          <Grid item xs={12} sm={6} md={4} style={{ paddingBottom: "2vw" }}>
          ...
          <Table aria-label="customized table">
            <TableHead>
              <TableRow style={{ textAlign: "center" }}>
                <StyledTableCell>Loan Account No.</StyledTableCell>
                <StyledTableCell>Account Name</StyledTableCell>
                <StyledTableCell>Account Status</StyledTableCell>
                <StyledTableCell>Balance</StyledTableCell>
                <StyledTableCell>Loan Account Type</StyledTableCell>
              </TableRow>
            </TableHead>
              ...
              {
                loanAccounts?  loanAccounts?.map((row , index) => <>
        ...
        <div className={classes.Sbox2}>
          <div style={{ width: "100%", marginBottom: "10px" }}>
            <MUIDataTable
              ...
              data={loanAccounts ? loanAccounts :[]}
              columns={columns}
              options={options}
            />
          </div>
