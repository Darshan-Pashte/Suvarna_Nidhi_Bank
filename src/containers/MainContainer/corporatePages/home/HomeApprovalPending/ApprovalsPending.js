...
const ApprovalsPending = ({ accList }) => {
  ...
  const handleTransfer = () => {
    navigate("/payments/fundtransfer");
  };

  const handleupload = () => {
    navigate("/payments/bulkpayment");
  };
            ...
            <div className={classes.formbox}>
              <div className={classes.textApproval}>
                <div className={classes.fundsText}>
                  ...
                  <div onClick={handleTransfer} style={{ cursor: "pointer" }}>
              ...
              <div className={classes.textApproval}>
                ...
                <div className={classes.fundsText} onClick={handleupload} style = {{cursor:"pointer"}}>
                  <div>
